...
public class MongoStationPair {
	...
	public double minTime, maxTime; // how long the shortest/longest trip took (in seconds)
	public String minDay, maxDay; // day of the week on which shortest/long trip took place
